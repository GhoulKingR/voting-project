...
import { FormEvent, useRef, RefObject, useEffect } from "react";
import styled from "styled-components";

function submitFactory(
  router: AppRouterInstance,
  matricField: RefObject<HTMLInputElement | null>,
  ...
  return (
    <Main>
      <Form
        ...
        onSubmit={submitFactory(router, matricField, passwordField)}
      >
        <Image
