    ...
    <RestOfPage>
        ...
        <Section2 className="p-[60px] text-center">
          ...
          <div className="py-[20px] flex flex-col lg:flex-row justify-between w-[90%] max-w-[1100px] mx-auto">
            <Link href="/profiles" className="flex text-left vote-card w-full mb-[20px] lg:mb-0 lg:w-[46%] lg:max-w-[530px]">
            ...
            <Link href="/schedules" className="flex text-left vote-card w-full lg:w-[46%] lg:max-w-[530px]">
